...
public class VotoServiceTest extends BaseTestCase {
  ...
  @Test public void shouldSuccessfullyCreateSubscriber() throws IOException {
    Call<CreateSubscriberResponse> call = mMockVotoService.createSubscriber("", null);
  ...
  @Test public void shouldSuccessfullyCreateBulkSubscribers() throws IOException {
    Call<CreateBulkSubscribersResponse> call =
        mMockVotoService.createBulkSubscribers("", null, null);
  ...
  @Test public void shouldSuccessfullyFetchMessageDeliveryCount() throws IOException {
