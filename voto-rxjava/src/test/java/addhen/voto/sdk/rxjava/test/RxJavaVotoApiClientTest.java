...
public class RxJavaVotoApiClientTest extends BaseTestCase {
  ...
  @Test public void shouldThrowExceptionWhenEmptyPhoneNumberIsSet() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenEmptyPhoneNumbersIsSet() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenIdIsNull() {
    try {
  ...
  @Test public void shouldSuccessfullyCreateSubscriber() throws IOException {
    Observable<CreateSubscriberResponse> observable =
        mRxJavaVotoApiClient.createSubscriber("0243555333889", null);
  ...
  @Test public void shouldSuccessfullyCreateBulkSubscribers() throws IOException {
    ...
    Observable<CreateBulkSubscribersResponse> observable =
        mRxJavaVotoApiClient.createBulkSubscribers("0243555333889", null, null);
  ...
  @Test public void shouldSuccessfullyDeleteSubscriber() throws IOException {
    Observable<DeleteSubscriberResponse> observable = mRxJavaVotoApiClient.deleteSubscriber(1L);
  ...
  @Test public void shouldSuccessfullyModifySubscriber() throws IOException {
    Observable<CreateSubscriberResponse> observable =
        mRxJavaVotoApiClient.modifySubscriberDetails(1L, null);
    TestSubscriber<CreateSubscriberResponse> result = new TestSubscriber<>();
    observable.subscribe(result);
    CreateSubscriberResponse createSubscriberResponse = result.getOnNextEvents().get(0);
    assertNotNull(createSubscriberResponse);
  ...
  @Test public void shouldSuccessfullyListSubscriberDetails() throws IOException {
    Observable<SubscriberDetailsResponse> observable =
        mRxJavaVotoApiClient.listSubscriberDetails(1L);
  ...
  @Test public void shouldSuccessfullyListAudioFileDetails() throws IOException {
    Observable<AudioFileDetailsResponse> observable = mRxJavaVotoApiClient.listAudioFileDetails(1L);
  ...
  @Test public void shouldSuccessfullyUploadAudioFileContent() throws IOException {
    Observable<UploadAudioFileResponse> observable =
        mRxJavaVotoApiClient.uploadAudioFileContent("description", AudioFileExtension.MP3, null);
  ...
  @Test public void shouldSuccessfullyUpdateAudioFileContent() throws IOException {
    Observable<UploadAudioFileResponse> observable =
        mRxJavaVotoApiClient.updateAudioFileContent(1L, AudioFileExtension.MP3, null);
    TestSubscriber<UploadAudioFileResponse> result = new TestSubscriber<>();
    observable.subscribe(result);
    UploadAudioFileResponse response = result.getOnNextEvents().get(0);
    assertNotNull(response);
  ...
  @Test public void shouldThrowExceptionWhenApiKeyIsNull() {
    try {
      new RxJavaVotoApiClient.Builder(null).build();
      fail();
    } catch (IllegalArgumentException e) {
  ...
  @Test public void shouldBuildRxJavaVotoApiClient() {
    RxJavaVotoApiClient rxVotoClient = new RxJavaVotoApiClient.Builder("api_key").build();
    assertNotNull(rxVotoClient);
  }

  @Test public void shouldMakeSureLimitIsSet() {
  ...
  @Test public void shouldMakeSureIsDefaultLimit() {
  ...
  @Test public void shouldThrowExceptionWhenEmptyDescriptionIsSet() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenEmptyFileExtensionIsSet() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenUpdateAudioFileContentFileIdIsNull()
      throws IOException {
    try {
  ...
  @Test public void shouldThrowExceptionWhenDownloadFileIdIsNull() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenDownloadFileFileFormatIsNotSet() {
    try {
  ...
  @Test public void shouldThrowExceptionWhenListSubscriberIdFieldIsNull() {
    try {
  ...
  @Test public void shouldSuccessfullyDownloadAudioFile() throws IOException {
    Observable<ResponseBody> observable =
        mRxJavaVotoApiClient.downloadAudioFile(1L, AudioFileFormat.ORIGINAL);
  ...
  @Test public void shouldSuccessfullyListAudioFile() throws IOException {
  ...
  @Test public void shouldSuccessfullyCreateMessages() throws IOException {
    Observable<CreateResponse> observable =
        mRxJavaVotoApiClient.createMessage("title", Status.NO, Status.YES, null);
  ...
  @Test public void shouldSuccessfullyGetMessageDeliveryLogCount() throws IOException {
    Observable<MessageDeliveryLogResponse> observable =
        mRxJavaVotoApiClient.getMessageDeliveryLog(1L, null);
  ...
  @Test public void shouldSuccessfullyGetMessageDetails() throws IOException {
    Observable<MessageDetailsResponse> observable = mRxJavaVotoApiClient.getMessageDetails(1L);
