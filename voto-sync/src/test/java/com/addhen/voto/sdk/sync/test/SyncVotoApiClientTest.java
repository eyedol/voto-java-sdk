...
public class SyncVotoApiClientTest extends BaseTestCase {
  ...
  @Test public void shouldSuccessfullyCreateBulkSubscribers() throws IOException {
    ...
    CreateBulkSubscribersResponse response =
        mSyncVotoApiClient.createBulkSubscribers("02345", null, null);
  ...
  @Test public void shouldSuccessfullyUploadAudioFileContent() throws IOException {
    UploadAudioFileResponse response =
        mSyncVotoApiClient.uploadAudioFileContent("description", AudioFileExtension.MP3, null);
    assertNotNull(response);
  }
  ...
  @Test public void shouldThrowExceptionWhenApiKeyIsNull() {
    try {
      new SyncVotoApiClient.Builder(null).build();
      fail();
    } catch (IllegalArgumentException e) {
  ...
  @Test public void shouldBuildRxJavaVotoApiClient() {
    SyncVotoApiClient syncVotoClient = new SyncVotoApiClient.Builder("api_key").build();
    assertNotNull(syncVotoClient);
  }

  @Test public void shouldMakeSureLimitIsSet() throws IOException {
  ...
  @Test public void shouldThrowExceptionWhenListSubscriberDetailsFileIdIsNull() throws IOException {
    try {
  ...
  @Test public void shouldSuccessfullyCreateMessage() throws IOException {
    CreateResponse createResponse =
        mSyncVotoApiClient.createMessage("title", com.addhen.voto.sdk.model.Status.NO,
  ...
  @Test public void shouldSuccessfullyGetMessageDetails() throws IOException {
    MessageDetailsResponse messageDetailsResponse = mSyncVotoApiClient.getMessageDetails(1L);
