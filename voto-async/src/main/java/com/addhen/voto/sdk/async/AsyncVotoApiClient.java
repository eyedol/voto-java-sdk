...
public class AsyncVotoApiClient extends BaseVotoApiClient {
  ...
  public void createSubscriber(String phone, Map<String, String> optionalFields,
      Callback<CreateSubscriberResponse> callback) throws IOException {
    if (StringUtils.isEmpty(phone)) {
      throw new IllegalArgumentException(PHONE_NUMBER_REQUIRED);
    }
    Call<CreateSubscriberResponse> createSubscriber =
        mAsyncVotoService.createSubscriber(phone, optionalFields);
    createSubscriber.enqueue(callback);
  }

  public void createBulkSubscribers(String phoneNumbers, IfPhoneNumberExists ifPhoneNumberExists,
    ...
    Call<CreateBulkSubscribersResponse> createBulkSubscribers =
        mAsyncVotoService.createBulkSubscribers(phoneNumbers, ifPhoneNumberExists, optionalFields);
  ...
  public void listSubscribers(int limit, Callback<ListSubscribersResponse> callback) {
    ...
    Call<ListSubscribersResponse> listSubscribers = mAsyncVotoService.listSubscribers(this.limit);
  ...
  public void modifySubscriberDetails(Long id, Map<String, String> optionalFields,
    ...
    Call<CreateSubscriberResponse> modifySubscriber =
        mAsyncVotoService.modifySubscriberDetails(id, optionalFields);
  ...
  public void deleteSubscriber(Long id, Callback<DeleteSubscriberResponse> callback) {
    ...
    Call<DeleteSubscriberResponse> deleteSubscriber = mAsyncVotoService.deleteSubscriber(id);
  ...
  public void uploadAudioFileContent(String description, AudioFileExtension fileExtension,
      Map<String, String> optionalFields, Callback<UploadAudioFileResponse> callback)
      throws IOException {
    ...
    Call<UploadAudioFileResponse> call =
        mAsyncVotoService.uploadAudioFileContent(description, fileExtension, optionalFields);
    call.enqueue(callback);
  }

  public void listAudioFileDetails(Long id, Callback<AudioFileDetailsResponse> callback)
      throws IOException {
    if (id == null) {
      throw new IllegalArgumentException(ID_REQUIRED);
    }
  ...
  public void updateAudioFileContent(Long id, AudioFileExtension fileExtension,
      Map<String, String> optionalFields, Callback<UploadAudioFileResponse> callback) {
    if (id == null) {
      throw new IllegalArgumentException(ID_REQUIRED);
    }
    ...
    Call<UploadAudioFileResponse> call =
        mAsyncVotoService.updateAudioFileContent(id, fileExtension, optionalFields);
    call.enqueue(callback);
  }
  ...
  public void createMessage(String title, Status hasSms, Status hasVoice,
    ...
    Call<CreateResponse> call =
        mAsyncVotoService.createMessage(title, hasSms, hasVoice, optionalFields);
    call.enqueue(callback);
  }
  ...
  public void getMessageDeliveryLog(Long id, Map<String, String> optionalFields,
      Callback<MessageDeliveryLogResponse> callback) {
    Call<MessageDeliveryLogResponse> call =
        mAsyncVotoService.getMessageDeliveryLog(id, optionalFields);
    call.enqueue(callback);
  }

  public void getMessageDetails(Long id, Callback<MessageDetailsResponse> callback) {
    Call<MessageDetailsResponse> call = mAsyncVotoService.getMessageDetails(id);
    call.enqueue(callback);
  }
  ...
  public static class Builder extends BaseApiBuilder<Builder, AsyncVotoApiClient> {
    ...
    @Override public AsyncVotoApiClient build() {
      initDefaultRetrofit();
